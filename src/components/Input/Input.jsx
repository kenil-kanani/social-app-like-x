...
function Input() {
    ...
    async function createPost() {
        ...
        //             firstName: 'Pawel',
        //             lastName: 'Kowalski',
        //             picture: 'https://dummyapi.io/data/v1/user/60d0fe4f5311236168a109ca/avatar'
        //         },
        //         text: postText,
    ...
    return (
        <Box sx={{ mt: '1rem' }}>
            ...
            {!isLoading ? <Button variant="contained" onClick={createPost}>Submit</Button> : <LoadingButton loading variant="outlined">Submit</LoadingButton>}
        </Box>
    )
}
